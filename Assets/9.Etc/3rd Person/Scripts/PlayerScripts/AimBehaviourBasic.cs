...
public class AimBehaviourBasic : GenericBehaviour
{
	...
	public float aimTurnSmoothing = 0.30f;                                // Speed of turn response when aiming to match camera facing.
	public Vector3 aimPivotOffset = new Vector3(0.5f, 1.2f,  0f);         // Offset to repoint the camera when aiming.
	public Vector3 aimCamOffset   = new Vector3(3f, 0.0f, 0f);         // Offset to relocate the camera when aiming.
